...
const initMapDirections = () => {
    gMap.value.$mapPromise.then((mapObject) => {
        ...
        let originPoint = new google.maps.LatLng(parseFloat(trip.origin.lat), parseFloat(trip.origin.lng)),
            destinationPoint = new google.maps.LatLng(parseFloat(trip.destination.lat), parseFloat(trip.destination.lng)),
